    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAvailabilities", x => new { x.UserId, x.AvailableDate });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LLMGeneratedPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LLMGeneratedPlans_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LLMGeneratedPlans_Users_GeneratedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventDocuments_UploadedBy",
                table: "EventDocuments",
                column: "UploadedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LLMGeneratedPlans_GeneratedBy",
                table: "LLMGeneratedPlans",
                column: "GeneratedBy");
